            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Nome do cliente, telefone ou email',
              ...
              child: clientesFiltrados.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final totalAgendamentos = agendamentosCliente.length;
                        final totalItens = totalServicos + totalAgendamentos;
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                if (totalItens > 0) ...[
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          '$totalItens item${totalItens > 1 ? 's' : ''} no histórico (${totalServicos} serviço${totalServicos != 1 ? 's' : ''}, ${totalAgendamentos} agendamento${totalAgendamentos != 1 ? 's' : ''})',
                                ...
                                if (pedidosCliente.isNotEmpty) ...[
                                  const SizedBox(height: 4),
                                  ...pedidosCliente.take(2).map((pedido) {
                                    final servicos = pedido.servicos.take(2);
                                    return Padding(
                                ...
                                if (agendamentosCliente.isNotEmpty) ...[
                                  const SizedBox(height: 4),
                                  ...agendamentosCliente.take(2).map((agendamento) {
                                    final servicoNome = agendamento.servico?.nome ?? 
                                        (agendamento.observacoes ?? 'Agendamento');
                                    final petNome = agendamento.pet?.nome;
                                    return Padding(
                                      padding: const EdgeInsets.only(top: 2),
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              '$servicoNome${petNome != null ? ' - $petNome' : ''}',
                                              style: TextStyle(
                                                color: colorScheme.onSurfaceVariant,
                                                fontSize: 11,
                                              ),
