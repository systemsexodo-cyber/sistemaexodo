...
class ContaReceberFormPage extends StatefulWidget {
  final ContaPagar? contaPagar;
  final String? categoriaPredefinida;

  const ContaReceberFormPage({super.key, this.contaPagar, this.categoriaPredefinida});

  @override
  State<ContaReceberFormPage> createState() => _ContaReceberFormPageState();
}

class _ContaReceberFormPageState extends State<ContaReceberFormPage> {
  ...
  void initState() {
    ...
    if (_ehRecebivel) {
      _categoriaController.text = 'Recebível';
    } else if (widget.categoriaPredefinida != null) {
  ...
  Widget build(BuildContext context) {
    ...
    return AppTheme.appBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(widget.contaPagar != null 
              ? (_ehRecebivel ? 'Editar Recebível' : 'Editar Conta') 
              : (_ehRecebivel ? 'Nova Conta a Receber' : 'Nova Conta a Pagar')),
          centerTitle: true,
          backgroundColor: Colors.transparent,
          elevation: 0,
        ),
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              if (!_ehRecebivel && _tipoSelecionado == TipoContaPagar.notaEntrada) ...[
                ...
                Autocomplete<Cliente>(
                  ...
                  optionsBuilder: (TextEditingValue textEditingValue) {
                    if (textEditingValue.text.isEmpty) {
                      return dataService.clientes;
                    }
                    return dataService.clientes.where((c) =>
                        c.nome.toLowerCase().contains(textEditingValue.text.toLowerCase()));
                  },
                  onSelected: (Cliente c) {
                    _fornecedorController.text = c.nome;
                  },
                  fieldViewBuilder: (context, controller, focusNode, onFieldSubmitted) {
                    if (controller.text.isEmpty && _fornecedorController.text.isNotEmpty) {
                      controller.text = _fornecedorController.text;
                    }
                    controller.addListener(() {
                      _fornecedorController.text = controller.text;
                    });
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return ListTile(
                                ...
                                title: Text(option.nome, style: const TextStyle(color: Colors.white)),
                                subtitle: option.telefone != null ? Text(option.telefone!, style: const TextStyle(color: Colors.white70)) : null,
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _ehRecebivel ? Colors.blueAccent : Colors.orange,
