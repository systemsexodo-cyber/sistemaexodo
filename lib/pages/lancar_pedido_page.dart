...
class _LancarPedidoPageState extends State<LancarPedidoPage> {
  ...
  Future<void> _salvarPedido() async {
    ...
    if (_clienteSelecionado != null) {
      final partes = <String>[];
      if (_clienteSelecionado!.endereco != null && _clienteSelecionado!.endereco!.isNotEmpty) {
        partes.add(_clienteSelecionado!.endereco!);
        if (_clienteSelecionado!.numero != null && _clienteSelecionado!.numero!.isNotEmpty) {
          partes.add(_clienteSelecionado!.numero!);
        }
      }
      if (_clienteSelecionado!.bairro != null && _clienteSelecionado!.bairro!.isNotEmpty) {
        partes.add(_clienteSelecionado!.bairro!);
      }
      if (_clienteSelecionado!.cidade != null && _clienteSelecionado!.cidade!.isNotEmpty) {
        String cidadeEstado = _clienteSelecionado!.cidade!;
        if (_clienteSelecionado!.estado != null && _clienteSelecionado!.estado!.isNotEmpty) {
          cidadeEstado += ' - ${_clienteSelecionado!.estado}';
        }
