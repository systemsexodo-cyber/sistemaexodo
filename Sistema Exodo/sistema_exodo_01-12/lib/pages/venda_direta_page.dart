...
class _VendaDiretaPageState extends State<VendaDiretaPage> {
  ...
  List<dynamic> _buscarItens(DataService dataService) {
    ...
    for (final produto in dataService.produtos) {
      ...
      // 9. Busca por múltiplas palavras
      ...
      // 10. Nome contém o termo (3+ caracteres)
                    ...
                    child: termoBusca.isEmpty
                        ...
                        : resultados.isEmpty
                            ...
                            : ListView.builder(
                                ...
                                itemCount: resultados.length > 10 ? 10 : resultados.length,
  ...
  void _salvarVendaPendente(
    ...
    // Para vendas salvas (tipo "outro"), criar também um Pedido para aparecer na aba "Receber"
    if (tipoPrincipal == TipoPagamento.outro) {
      ...
      // Criar pagamento do tipo "outro" (não recebido)
      final pagamentoOutro = PagamentoPedido(
        id: uuid.v4(),
