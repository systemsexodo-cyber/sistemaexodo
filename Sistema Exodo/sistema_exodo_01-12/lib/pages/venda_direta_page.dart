...
import '../services/xml_builder_service.dart';
...
class _VendaDiretaPageState extends State<VendaDiretaPage> {
  ...
  Future<void> _emitirNFCe(VendaBalcao vendaBalcao) async {
    try {
      ...
      if (empresa.certificadoDigitalUrl == null || empresa.senhaCertificado == null) {
      ...
      if (mounted) {
        Navigator.pop(context);
        _mostrarErro('Erro ao emitir NFC-e: $e');
      }
    }
  }
  ...
  void _mostrarErro(String mensagem) {
    ...
    // Mostrar diálogo de erro muito visível com animação
    showDialog(
      context: context,
      barrierDismissible: true,
      barrierColor: Colors.black.withOpacity(0.95), // Fundo quase preto
            ...
            child: AlertDialog(
              ...
              content: Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    // Ícone de erro grande e animado com pulso
                    ...
                    const SizedBox(height: 32),
                    // Botão de fechar grande e destacado
                    SizedBox(
                      width: double.infinity,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Número: ${nfce.numero}'),
            if (nfce.chaveAcesso != null)
              Padding(
                padding: const EdgeInsets.only(top: 8),
                child: Text(
                  'Chave: ${nfce.chaveAcesso}',
            ...
            if (nfce.protocolo != null)
              Padding(
                padding: const EdgeInsets.only(top: 8),
                child: Text('Protocolo: ${nfce.protocolo}'),
              ),
          ],
        ),
        actions: [
