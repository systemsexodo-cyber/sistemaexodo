...
with open('c:/Users/USER/.gemini/antigravity/sistema_exodo_01-12/tmp/test_out.txt', 'w') as f:
    f.write('START\\n')
...
try:
    ...
    with open('c:/Users/USER/.gemini/antigravity/sistema_exodo_01-12/tmp/test_out.txt', 'a') as f:
            ...
            try:
                ...
                with open('c:/Users/USER/.gemini/antigravity/sistema_exodo_01-12/tmp/test_out.txt', 'a') as f:
                    ...
                    for err in schema.error_log:
                        f.write(err.message + '\\n')
        except Exception as xsd_e:
            with open('c:/Users/USER/.gemini/antigravity/sistema_exodo_01-12/tmp/test_out.txt', 'a') as f:
                f.write('ERRO AO CARREGAR XSD:\\n' + str(xsd_e) + '\\n')
